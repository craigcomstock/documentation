...
export BRANCH=$1
export BRANCH=master # todo figure out from package?
...
cp /nt/packages/cfengine*deb "cfengine-nova-hub.deb"

# TODO make this re-runnable without re-installing/unpacking the package :)
